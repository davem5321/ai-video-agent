...
### Phase 2 — Threat Model (delegated)

Delegate to the **ThreatModeler** sub-agent to produce a complete `audit/THREAT_MODEL.md`:
...
Wait for ThreatModeler to complete. Reference `audit/THREAT_MODEL.md` in the final audit report.
